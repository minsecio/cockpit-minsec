 ...
 *
 * From cockpit's pkg/lib/cockpit-dark-theme.ts, with the type annotations
 * removed. Import once per page: it follows the shell's theme switcher and
 * the operating system preference by toggling pf-v6-theme-dark on <html>.
 */
